...
import { FileText, ShieldCheck, Building2, ExternalLink } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 flex flex-col font-sans">
      ...
      <section className="relative pt-12 pb-16 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-900 border-b border-slate-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-slate-400 text-sm sm:text-base mt-2">
            Effective Date: July 2026 • Registered Entity: <strong className="text-slate-200">Arman Logical Systems</strong>
          </p>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-12 flex-grow w-full space-y-8 text-slate-300 leading-relaxed text-sm">
        ...
        <div className="p-6 rounded-3xl bg-slate-800/80 border border-slate-700 space-y-3 shadow-lg">
          ...
          <p>
            Welcome to <strong>Arman Logical Systems</strong> (accessible at <Link href="https://Armanlogicalsystems.in" className="text-blue-400 underline">https://Armanlogicalsystems.in</Link>). This website and all affiliated web platforms (Schoolahive ERP, DineServe POS, ClinicMind Hub, LocalHub Market) are operated under Merchant Owner <strong>Sahin Arman</strong> (PAN: CKCPA4185J).
          </p>
          <p>
        ...
        <div className="space-y-3">
          ...
          <p>
            By initiating payments on our portal (<Link href="/pay" className="text-blue-400 underline">https://Armanlogicalsystems.in/pay</Link>) using Google Pay, UPI, Cards, or Net Banking, you agree to provide true, accurate, and complete billing details.
          </p>
        ...
        <div className="space-y-3">
          ...
          <div className="p-4 rounded-2xl bg-slate-800 border border-slate-700 font-mono text-xs text-slate-300 space-y-1">
