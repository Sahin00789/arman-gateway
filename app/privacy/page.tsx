      ...
      <section className="relative pt-12 pb-16 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-900 border-b border-slate-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-slate-400 text-sm sm:text-base mt-2">
            Last Updated: July 2026 • Official Privacy Notice for <strong className="text-slate-200">Arman Logical Systems</strong>
          </p>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-12 flex-grow w-full space-y-8 text-slate-300 leading-relaxed text-sm">
        ...
        <div className="space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-1 text-slate-300">
            ...
            <li>Responding to customer support tickets submitted via <a href="/support" className="text-blue-400 underline">/support</a>.</li>
        ...
        <div className="p-6 rounded-3xl bg-slate-800 border border-slate-700 space-y-2 font-mono text-xs">
          <div className="font-bold text-white text-sm font-sans mb-1">Grievance & Data Privacy Contact</div>
