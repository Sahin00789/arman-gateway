...
import { ShieldCheck, RotateCcw, Clock, AlertTriangle, CheckCircle2 } from "lucide-react";
      ...
      <section className="relative pt-12 pb-16 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-900 border-b border-slate-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-slate-400 text-sm sm:text-base mt-2">
            Last Updated: July 2026 • Official Policy for <strong className="text-slate-200">Arman Logical Systems</strong> (MCC 7372)
          </p>
        </div>
      </section>

      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-12 flex-grow w-full space-y-8 text-slate-300 leading-relaxed text-sm">
        ...
        <div className="space-y-3">
          ...
          <div className="p-4 rounded-2xl bg-slate-800/50 border border-slate-700 space-y-2">
            <div className="font-bold text-white">Refund Destination:</div>
            ...
            <div className="font-bold text-white mt-2">Processing Duration:</div>
        ...
        <div className="p-6 rounded-3xl bg-blue-950/30 border border-blue-800/40 space-y-3">
          ...
          <div className="pt-2 text-sm text-slate-200 space-y-1 font-mono">
            <div>Email: <a href="mailto:sahin401099@gmail.com" className="text-blue-400 underline">sahin401099@gmail.com</a></div>
            <div>Phone: <a href="tel:+919563401099" className="text-emerald-400 underline">+91 95634 01099</a></div>
            <div>Support Desk: <Link href="/support" className="text-cyan-400 underline">https://Armanlogicalsystems.in/support</Link></div>
          </div>
        </div>
