          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tight">
                Customer Support <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-cyan-600 dark:from-blue-400 dark:to-cyan-300">& Resolution Hub</span>
              </h1>
            ...
            <div className="p-4 rounded-2xl bg-white dark:bg-blue-950/40 border border-slate-200 dark:border-blue-800/40 shadow-xs text-xs text-slate-700 dark:text-slate-300 space-y-1">
              <div className="font-bold text-slate-900 dark:text-white text-sm">Resolution SLA</div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 flex-grow w-full space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-3xl bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 space-y-3 shadow-md">
            <div className="w-12 h-12 rounded-2xl bg-blue-50 dark:bg-blue-600/20 border border-blue-200 dark:border-blue-500/30 flex items-center justify-center">
              <Mail className="w-6 h-6 text-blue-600 dark:text-blue-400" />
            </div>
            <div>
              <div className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Customer Support Email</div>
              <a href="mailto:sahin401099@gmail.com" className="text-lg font-bold text-slate-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors block mt-1">
          ...
          {/* Card 2: Phone */}
          <div className="p-6 rounded-3xl bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 space-y-3 shadow-md">
            <div className="w-12 h-12 rounded-2xl bg-emerald-50 dark:bg-emerald-600/20 border border-emerald-200 dark:border-emerald-500/30 flex items-center justify-center">
              <Phone className="w-6 h-6 text-emerald-600 dark:text-emerald-400" />
            </div>
            <div>
              <div className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Direct Phone & WhatsApp</div>
              <a href="tel:+919563401099" className="text-lg font-bold text-slate-900 dark:text-white hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors block mt-1">
                +91 95634 01099
              </a>
            </div>
            <p className="text-xs text-slate-500 dark:text-slate-400">
          ...
          <div className="p-6 rounded-3xl bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 space-y-3 shadow-md">
            <div className="w-12 h-12 rounded-2xl bg-cyan-50 dark:bg-cyan-600/20 border border-cyan-200 dark:border-cyan-500/30 flex items-center justify-center">
              <Building2 className="w-6 h-6 text-cyan-600 dark:text-cyan-400" />
            </div>
            <div>
              <div className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Registered Business Profile</div>
              <div className="text-lg font-bold text-slate-900 dark:text-white mt-1">Arman Logical Systems</div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 p-8 rounded-3xl bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 shadow-xl space-y-6">
            <div>
            ...
            {submittedTicketId ? (
              <div className="p-6 rounded-2xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-500/40 text-center space-y-4">
                <CheckCircle2 className="w-12 h-12 text-emerald-600 dark:text-emerald-400 mx-auto" />
                <h4 className="text-xl font-bold text-slate-900 dark:text-white">Support Ticket Created!</h4>
                <p className="text-slate-600 dark:text-slate-300 text-sm">
                  Your ticket reference number is <strong className="text-emerald-600 dark:text-emerald-400 font-mono">{submittedTicketId}</strong>.
                  Our team will review your message and reach out to <strong>{ticketEmail}</strong> shortly.
                </p>
                <button
                  onClick={handleResetForm}
                  className="px-5 py-2.5 rounded-xl bg-slate-900 dark:bg-slate-800 hover:bg-slate-800 text-white text-xs font-bold transition-all"
                >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white text-sm focus:border-blue-500 focus:outline-hidden"
                    />
                  </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="p-6 rounded-3xl bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 shadow-xl space-y-4">
              ...
              <div className="space-y-4 text-xs">
                <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-1">
                  <h4 className="font-bold text-slate-900 dark:text-white text-sm">How long does a Google Pay transaction take to process?</h4>
                ...
                <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-1">
                  <h4 className="font-bold text-slate-900 dark:text-white text-sm">What should I do if money was deducted but status is pending?</h4>
                  <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                ...
                <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-1">
                  <h4 className="font-bold text-slate-900 dark:text-white text-sm">What is Arman Logical Systems refund policy?</h4>
                  <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                    We offer a 7-day refund policy for software subscriptions and service contracts. View our detailed policy on the <a href="/refund-policy" className="text-blue-600 dark:text-blue-400 hover:underline">Refund Policy Page</a>.
                  </p>
                </div>

                <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-1">
                  <h4 className="font-bold text-slate-900 dark:text-white text-sm">What services fall under MCC 7372?</h4>
                  <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
